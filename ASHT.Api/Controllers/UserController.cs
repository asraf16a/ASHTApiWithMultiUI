using ASHT.Application.Hrm.User.Commands.Create;
using ASHT.Application.Hrm.User.Queries.GetAllUserQueries;
...
namespace ASHT.Api.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public async Task<ActionResult<APIResponse>> AddUser(CreateUserCommand command)
        {
            try
            {
                if (command == null)
